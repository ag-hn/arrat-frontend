...
// } from "@/components/blocks/data-table.utils";
// import { useLocalStorage } from "@uidotdev/usehooks";
// import { largeNumberFormatter } from "@/lib/formatters/number-value-formatter";
...
//                 <span>
//                   Use <Badge variant="outline">↑</Badge>{" "}
//                   <Badge variant="outline">↓</Badge> to navigate
//                 </span>
//                 <span>
//                   <Badge variant="outline">Enter</Badge> to query
//                 </span>
//                 <span>
//                   <Badge variant="outline">Esc</Badge> to close
//                 </span>
//                 <Separator orientation="vertical" className="my-auto h-3" />
//                 <span>
//                   Union: <Badge variant="outline">regions:a,b</Badge>
//                 </span>
//                 <span>
//                   Range: <Badge variant="outline">p95:59-340</Badge>
//                 </span>
//               </div>
//               {lastSearches.length ? (
//                 <button
